...
<head>
    ...
    <title>Cash Out - <?php echo $website ; ?> </title>
</head>
...
<div class="mainbody">
    <div class="topprofile pd20">
        ...
        <div class="wallet">
            <a href="logout.php"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
...
<?php require 'menuji.php' ; ?>
    ...
    <div class="userupdate pd20">
        ...
        <h1 class="editjiuser">CASH OUT</h1>

        <?php 
                    $premium = "paidpremium";
                    if ($premium == "paidpremium" ) {
                        ?>
                              <form action="hcashout.php" class="editu" method="post" enctype="multipart/form-data">
                                <div class="ffields">
